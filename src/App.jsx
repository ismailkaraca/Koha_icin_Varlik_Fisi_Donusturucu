                        ...
                        <div className="flex">
                            ...
                            <div>
                                ...
                                <p className="text-sm">
                                    ...
                                    >dokümanda</a>
                                    yer verilmektedir. Lütfen, ilgili sütunların eksiksiz doldurulduğuna dikkat ediniz. "malzemeAdi" sütununun formatının (<strong>YAZAR SOYADİ-ESER ADI-ISBN</strong> gibi), örnekteki (Orhan Pamuk-Kelebek Zihinli Çocuk-9786050837933) örneğindeki gibi olması gerekmektedir. Bu bilginin eksik veya yanlış girilmesi durumunda dönüştürme işleminin işlevsiz kalacağı bilinmelidir.</p>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
                        ...
                        <div className="mt-6 text-center">
                            ...
                            >
                                {isLoading ? (
                                    <>
                                        <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/0" fill="none" viewBox="0 0 24 24">
                        ...
                        <div className="mt-10 bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">D\u00f6n\u00fc\u015ft\u00fcr\u00fclen veriler a\u015f\u011f\u0131da listelenmi\u015ftir. Tam listeyi Excel olarak indirebilirsiniz.</p>
                                </div>
                                <button
