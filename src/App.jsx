            ...
            <div className="w-full max-w-5xl mx-auto">
                ...
                <main>
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200 mb-4">
                        ...
                        {showInfo && (<div className="mt-4 text-gray-600 space-y-4 border-t pt-4">
<p>Bu uygulama Hazine va Maliye Bakanlığı'nın Taşınır Kontrol Yönetim Sistemi'ne girilen kitapların Varlık İşlem Fişi (VİF) - [Eski adıyla TİF] dosyasının Koha Kütüphane Otomasyon Sistemi KBS'den Tif Aktar modülüne aktarılacak formatını otomatik oluşturmaya yaramaktadır.</p><p>Uygulamanın tam işlevsellikle çalışabilmesi ve veri bütünlüğünün sağlanması için, TKYS sistemine şablonla veri girişi yapılırken "Özel Kod/Modeli" alanına kitabın ISBN bilgisinin girilmesi önemle tavsiye edilir. ISBN bilgisinin olması, Koha sistemindeki işlemlerinizi daha verimli ve hatasız hale getirecektir.</p>
